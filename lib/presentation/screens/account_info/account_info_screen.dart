  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: ListView(
        children: [
          ...
          _buildContentRow(
              'フリガナ', 'assets/icons/icon_svg/name_ruby_icon.svg', 'アラカワ タロウ'),
          const SizedBox(
            height: 8,
          ),
          _buildContentRow('生年月日',
              'assets/icons/icon_svg/date_of_birth_icon.svg', '2020年1月20日'),
          const SizedBox(
            height: 8,
          ),
          _buildContentRow('性別', 'assets/icons/icon_svg/gender_icon.svg', '男性'),
          const SizedBox(
            height: 8,
          ),
          ...
          _buildContentRowInut('メールアドレス',
              'assets/icons/icon_svg/email_icon.svg', mailController, null),
          const SizedBox(
            height: 8,
          ),
          _buildContentRow('電話番号', 'assets/icons/icon_svg/phone_num_icon.svg',
              '000-0000-0000'),
          const SizedBox(
            height: 8,
          ),
...
'''),
          ...
          _buildContentRow(
              '自己PR', 'assets/icons/icon_svg/self_pr_icon.svg', '''xxxxxxxxxxxx
xxxxxxxxxxxxxxxx
